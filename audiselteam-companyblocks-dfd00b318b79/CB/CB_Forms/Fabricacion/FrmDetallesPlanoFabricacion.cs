...
namespace CB
{
    public partial class FrmDetallesPlanoFabricacion : Ventana
    {
        ...
        public void CargarDatosPlano(int idPlano)
        {
            ...
            if (cotizacion.TieneFilas() && Global.VerificarPrivilegio("GENERAL", "VISUALIZAR COSTOS") )
            {
            ...
            //Urgencias
            ListViewItem fechaPromesaUrgencia = new ListViewItem("Fecha promesa urgencia: ");
            if (plano.Fila().Celda("fecha_promesa_urgencia") != null)
                fechaPromesaUrgencia.SubItems.Add(Global.FechaATexto(plano.Fila().Celda("fecha_promesa_urgencia")));
            else
                fechaPromesaUrgencia.SubItems.Add("N/A");
            
            fechaPromesaUrgencia.Group = LvInfoPieza.Groups["Urgencia"];
            LvInfoPieza.Items.Add(fechaPromesaUrgencia);

            ListViewItem fechaSolicitudUrgencia = new ListViewItem("fecha de solicitud: ");
            if (plano.Fila().Celda("fecha_solicitud_urgencia") != null)
                fechaSolicitudUrgencia.SubItems.Add(Global.FechaATexto(plano.Fila().Celda("fecha_solicitud_urgencia")));
            else
                fechaSolicitudUrgencia.SubItems.Add("N/A");

            fechaSolicitudUrgencia.Group = LvInfoPieza.Groups["Urgencia"];
            LvInfoPieza.Items.Add(fechaSolicitudUrgencia);

            ListViewItem usuarioSolicitudUrgencia = new ListViewItem("Usuario solicitud: ");
            if (plano.Fila().Celda("usuario_solicitud_urgencia") != null)
                usuarioSolicitudUrgencia.SubItems.Add(plano.Fila().Celda("usuario_solicitud_urgencia").ToString());
            else
                usuarioSolicitudUrgencia.SubItems.Add("N/A");

            usuarioSolicitudUrgencia.Group = LvInfoPieza.Groups["Urgencia"];
            LvInfoPieza.Items.Add(usuarioSolicitudUrgencia);

            ListViewItem estatusUrgencia = new ListViewItem("Estatus urgencia: ");
            if (plano.Fila().Celda("estatus_urgencia") != null)
                estatusUrgencia.SubItems.Add(plano.Fila().Celda("estatus_urgencia").ToString());
            else
                estatusUrgencia.SubItems.Add("N/A");

            estatusUrgencia.Group = LvInfoPieza.Groups["Urgencia"];
            LvInfoPieza.Items.Add(estatusUrgencia);
